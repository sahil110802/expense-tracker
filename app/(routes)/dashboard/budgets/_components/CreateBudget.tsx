...
export default function CreateBudget({}: Props) {
  ...
  // amount: string | SQL<unknown> | Placeholder<string, any>; 
  // createdBy: string | SQL<unknown> | Placeholder<...>; id?: number | ... 2 more ... | undefined;
  //  icon?: string | ... 3 more ... | undefined; }[]
    ...
    <div>
      <Dialog>
        <DialogTrigger className="w-full">
          <div
            className="border-2 bg-gray-400 border-dashed rounded-lg p-10 items-center 
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <div className="mt-2">
                <h2 className="text-2xl text-black font-semibold my-1">
                  Create Budget
                </h2>
                <Input
